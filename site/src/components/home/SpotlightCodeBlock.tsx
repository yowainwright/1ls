...
const codeLines: CodeLine[] = [
  { prefix: "$", content: "bun add -g 1ls", spotlight: true, delay: 0 },
  ...
  {
    prefix: "",
    content: "Installed 1ls with binaries:",
    className: "text-base-content/60",
  },
  { prefix: "", content: " - 1ls", className: "text-success" },
  {
    prefix: "$",
  ...
  { prefix: "$", content: "1ls", spotlight: true, delay: 3000 },
  { prefix: "", content: " 1ls v1.4.0", className: "text-warning" },
  {
    prefix: "",
