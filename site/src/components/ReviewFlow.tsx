...
const nodes = [
  {
    ...
    data: {
      label: (
        <Label
          description="find"
          metaDescription="1ls finds overrides/resolutions in a repo's root package.json"
        />
      ),
    },
    style,
  },
  {
    ...
    data: {
      label: (
        <Label
          description="review"
          metaDescription="1ls compares 1ls.appendix against overrides/resolutions"
        />
      ),
    },
    style,
  },
  {
    ...
    data: {
      label: (
        <Label
          description="update"
          metaDescription="1ls updates a repo's overrides and resolutions in package.json"
        />
      ),
    },
    style,
  },
  {
    ...
    data: {
      label: (
        <Label
          description="add"
          metaDescription="1ls adds new overrides/resolutions to the appendix"
        />
      ),
    },
    style,
