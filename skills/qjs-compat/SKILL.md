...
Bun-only files (exempt from QJS rules): `src/cli/`, `src/fs/`, `src/completions/`, `src/tooltip/`
...
Modules that do NOT enter the bundle (Bun-only): `src/cli/`, `src/fs/`, `src/completions/`, `src/tooltip/`.
